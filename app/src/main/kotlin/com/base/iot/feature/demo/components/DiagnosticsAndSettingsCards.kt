...
fun DiagnosticsCard(vm: DashboardViewModel) {
    ...
    AppCard(title = stringResource(R.string.diag_card_title), icon = Icons.Filled.BugReport, iconTint = colors.accentRed) {
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Text(
                text = stringResource(R.string.diag_card_desc),
                color = colors.textSecondary,
                fontSize = 11.sp
            )
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                AppButton(
                    text = stringResource(R.string.diag_btn_long_log),
                ...
                AppButton(
                    text = stringResource(R.string.diag_btn_check_crash),
                ...
                AppButton(
                    text = stringResource(R.string.diag_btn_share_log),
...
fun UiSettingsCard(uiState: DashboardUiState, vm: DashboardViewModel) {
    ...
    AppCard(title = stringResource(R.string.settings_card_title), icon = Icons.Filled.Settings, iconTint = colors.accentCyan) {
        Row(
            ...
            Column {
                Text(
                    text = stringResource(R.string.settings_immersive_title),
                ...
                Text(
                    text = stringResource(
                        if (uiState.isImmersive) R.string.settings_immersive_on else R.string.settings_immersive_off
                    ),
                    color = colors.textSecondary,
                    fontSize = 11.sp
                )
        ...
        Row(
            ...
            AppButton(
                text = stringResource(R.string.settings_licenses_btn),
